...
export const InputPanel = ({ onClose, onConfirm }: InputPanelProps) => {
  const { setUserName } = useIntroStore();
        ...
        <div className="absolute flex flex-col items-center justify-center w-full h-full gap-8 pt-20">
          ...
          <div className="w-[150px] h-[80px]">
            ...
            >
              ...
              <span className="text-white text-2xl font-dot font-medium inline-block absolute text-center [-webkit-text-stroke:_2px_#FEA237;] [paint-order:stroke_fill] pointer-events-none">
                決めた
              </span>
            </div>
          </div>
