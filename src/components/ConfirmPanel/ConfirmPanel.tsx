...
const ConfirmPanel = ({ title, onClose, onConfirm, showButtons }: ConfirmPanelProps) => {
    ...
    return (
        ...
        >
            <div className="relative w-[735px] h-[660px] bg-transparent">
                ...
                {/* 右上角的叉 */}
                <div className="absolute top-8 right-12 z-20 cursor-pointer" onClick={onClose}> {/* Adjusted right position */}
                    <svg
                        width="48"
                        height="52"
                        viewBox="0 0 48 52"
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <rect x="0.488662" y="0.488662" width="47.0227" height="50.8409" fill="black" fillOpacity="0.2" stroke="#F0F0F0" strokeWidth="0.977324" />
                        <path d="M9.00684 10.6484L39.2796 40.9212" stroke="white" strokeWidth="0.977324" />
                        <path d="M39.2788 10.6484L9.00608 40.9212" stroke="white" strokeWidth="0.977324" />
                    </svg>
                </div>
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-white">
                    <p className="text-[#FFEFD0] font-dot text-3xl mb-8 text-center leading-relaxed"> {/* Adjust line height */}
                        {showButtons ? (
                            <>
                                <span>{`「${title}」`}</span>
                                <br /> {/* Line break */}
                                <span className="mt-1 inline-block">にしますか？</span> {/* Added top margin */}
                            </>
                        ) : (
                            "请选择您想要的食物"
                        )}
                ...
                {showButtons && (
                    <div className="absolute bottom-12 left-0 right-0 flex justify-center space-x-10">
                        ...
                        <div
                            ...
                            onClick={onClose}
                            className="relative w-[15vh] h-[6vh] flex justify-center items-center cursor-pointer"
                        >
                            <svg
                                className="absolute inset-0 w-full h-full"
                                preserveAspectRatio="none"
                            ...
                            >
                                <path
                                    d="M5.18924 5.38553L9.86979 0.5H237.13L246.5 10.2801V76.7199L241.811 81.6145L237.13 86.5H9.86979L5.18924 81.6145L0.5 76.7199V10.2801L5.18924 5.38553Z"
                                    fill="#FEA237"
                                    style={{ fillOpacity: isNoPressed ? 0.5 : 0.2, strokeOpacity: 1 }}
                                    stroke="#FEA237"
                                />
                            </svg>
                        ...
                        >
                            ...
                            >
                                <path
                                    d="M5.18924 5.38553L9.86979 0.5H237.13L246.5 10.2801V76.7199L241.811 81.6145L237.13 86.5H9.86979L5.18924 81.6145L0.5 76.7199V10.2801L5.18924 5.38553Z"
                                    fill="#FEA237"
                                    style={{ fillOpacity: isYesPressed ? 0.5 : 0.2, strokeOpacity: 1 }}
                                    stroke="#FEA237"
                                />
                            </svg>
                            <span className="text-white text-3xl font-dot font-medium absolute text-center [-webkit-text-stroke:_0.6px_#FEA237;] [paint-order:stroke fill] z-10">
