            ...
            <div className="grid grid-rows-[repeat(100,1fr)] grid-cols-[repeat(100,1fr)] w-full h-full border-[10px] border-orange bg-black relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center space-y-10">
                    <div className="relative">
                        ...
                        {/* receipt*/}
                        <img src={receipt} alt="receipt" className="absolute inset-0 m-auto z-20 animate-bouncing" />
                    </div>

                    {/* Loading文字和边框 */}
                    <div className="relative flex flex-col items-center">
                        {/* 上边框 */}
                        <div className="border-t-[1px] border-b-[1px] border-orange mb-2" style={{ width: '50%' }}></div>
                        {/* 文字 */}
                        <div className="leading-loose font-serif text-4xl leading-[1.2] text-orange [-webkit-text-stroke:_2.5px_#FFFFFF;] [paint-order:stroke_fill] text-center">
                            料理を準備中です。
                            <br />
                            しばらくお待ちください
                        ...
                        {/* 下边框 */}
                        <div className="border-t-[1px] border-b-[1px] border-orange mt-2" style={{ width: '50%' }}></div>
                    </div>
                </div>
