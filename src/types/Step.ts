export enum Step {
  ...
  MOOD_INTRO_START = "MOOD_INTRO_START",
  MOOD_INTRO_HAPPY = "MOOD_INTRO_HAPPY",
  MOOD_INTRO_ANGRY = "MOOD_INTRO_ANGRY",
  MOOD_INTRO_SAD = "MOOD_INTRO_SAD",
  MOOD_INTRO_END = "MOOD_INTRO_END",
